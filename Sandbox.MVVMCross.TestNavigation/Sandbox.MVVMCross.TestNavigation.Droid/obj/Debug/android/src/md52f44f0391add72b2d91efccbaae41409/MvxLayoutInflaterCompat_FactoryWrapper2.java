package md52f44f0391add72b2d91efccbaae41409;


public class MvxLayoutInflaterCompat_FactoryWrapper2
	extends md52f44f0391add72b2d91efccbaae41409.MvxLayoutInflaterCompat_FactoryWrapper
	implements
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MvvmCross.Binding.Droid.Binders.MvxLayoutInflaterCompat+FactoryWrapper2, MvvmCross.Binding.Droid, Version=5.2.1.0, Culture=neutral, PublicKeyToken=null", MvxLayoutInflaterCompat_FactoryWrapper2.class, __md_methods);
	}
	...
	public MvxLayoutInflaterCompat_FactoryWrapper2 ()
	{
		...
		if (getClass () == MvxLayoutInflaterCompat_FactoryWrapper2.class)
			mono.android.TypeManager.Activate ("MvvmCross.Binding.Droid.Binders.MvxLayoutInflaterCompat+FactoryWrapper2, MvvmCross.Binding.Droid, Version=5.2.1.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
