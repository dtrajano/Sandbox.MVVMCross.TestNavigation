...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "Sandbox_MVVMCross_TestNavigation.Droid.dll" comes first in this list. */
		"Sandbox_MVVMCross_TestNavigation.Droid.dll",
		...
		"Sandbox.MVVMCross.TestNavigation.Core.dll",
